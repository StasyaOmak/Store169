...
struct VerificationView: View {
    ...
    private var alertView: some View {
        ...
        .zIndex(1)
        .padding(20)
        .background(RoundedRectangle(cornerRadius: 10).fill(.lightGreen))
    }
...
extension AnyTransition {
    static var zoomAsymInOut: AnyTransition {
        .asymmetric(insertion: .scale(scale: 0.1,
                                      anchor: .topLeading)
            .combined(with: .offset(y: 220)), removal: .scale(scale: 0.5)
